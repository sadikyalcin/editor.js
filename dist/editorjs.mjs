...
let ko = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
function Ee(n, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const l = "Editor.js 2.30.0-rc.14-beta", a = `line-height: 1em;
            color: #006FEA;
...
async function yo(n, e = () => {
  ...
  async function o(i, s, r) {
    try {
      await i.function(i.data), await s(mt(i.data) ? {} : i.data);
    } catch {
      r(mt(i.data) ? {} : i.data);
    }
  }
...
function Ve(n, ...e) {
  ...
  if (R(n) && R(t))
    for (const o in t)
      R(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), Ve(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
  return Ve(n, ...e);
}
function Qe(n) {
  const e = To();
...
class d {
  ...
  static isElement(e) {
    return gt(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return gt(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
...
const Ge = "redactor dom changed", Pt = "block changed", Dt = "fake cursor is about to be toggled", Rt = "fake cursor have been set", xe = "editor mobile layout toggled";
function Ft(n, e) {
...
function vt(n, e) {
  return n.mergeable ? n.name === e.name ? !0 : Ae(e, "export") && Ae(n, "import") : !1;
}
function Ro(n, e) {
  const t = e == null ? void 0 : e.export;
  return L(t) ? t(n) : Q(t) ? n[t] : (t !== void 0 && I("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function wt(n, e) {
...
class le {
  ...
  constructor(e) {
    ...
    }, this.iterator = new ge(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || le.usedKeys;
  }
  /**
...
var Go = $t.exports;
const Jo = /* @__PURE__ */ Re(Go);
let z = null;
function et() {
  z || (z = new Jo());
}
function Qo(n, e, t) {
  et(), z == null || z.show(n, e, t);
}
function _e(n = !1) {
  et(), z == null || z.hide(n);
}
function Ne(n, e, t) {
  et(), z == null || z.onHover(n, e, t);
}
function ei() {
...
const ti = "__", oi = "--";
function te(n) {
  return (e, t) => [[n, e].filter((i) => !!i).join(ti), t].filter((i) => !!i).join(oi);
}
...
class ne extends tt {
  ...
  make(e, t) {
    var s, r;
    const o = (t == null ? void 0 : t.wrapperTag) || "div", i = d.make(o, A.container);
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = d.make("div", [A.icon, A.iconTool], {
      innerHTML: e.icon || Yo
    }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(d.make("div", A.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && i.appendChild(d.make("div", A.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.hasChildren && i.appendChild(d.make("div", [A.icon, A.iconChevronRight], {
      innerHTML: Uo
...
class Wt extends Be {
  ...
  buildItems(e) {
    return e.map((t) => {
      switch (t.type) {
        ...
        default:
          return new ne(t, this.itemsRenderParams[O.Default]);
      }
    });
  }
  /**
   ...
   */
  getTargetItem(e) {
    return this.items.filter((t) => t instanceof ne || t instanceof ye).find((t) => {
...
var ni = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, li = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ri(e, t) : e, s = n.length - 1, r; s >= 0; s--)
  ...
  constructor(e, t) {
    super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
      ...
      this.items.forEach((a) => {
        let c = !1;
        a instanceof ne ? c = !o.items.includes(a) : (a instanceof Yt || a instanceof ye) && (c = s || !i), a.toggleHidden(c);
...
class ai extends ot {
  ...
  constructor(e) {
    ...
    super(
      ...
      !(o instanceof ne) && !(o instanceof ye) || o.hasChildren && o.isChildrenOpen && this.showNestedItems(o);
    });
  }
  /**
   * Returns visible element offset top
...
const Vt = class ve {
   ...
   */
  lock() {
    Ze ? this.lockHard() : document.body.classList.add(ve.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    Ze ? this.unlockHard() : document.body.classList.remove(ve.CSS.scrollLocked);
  }
  /**
...
class qt extends Wt {
  ...
  constructor(e) {
    ...
    }), this.scrollLocker = new ci(), this.history = new hi(), this.isHidden = !0, this.nodes.overlay = d.make("div", [N.overlay, N.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
...
class D extends Be {
  ...
  async exportDataAsString() {
    ...
    return Ro(e, this.tool.conversionConfig);
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((s) => Do(s, this.toolRenderedElement)) && this.didMutated(o);
    }, (e = this.editorEventBus) == null || e.on(Ge, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null || e.off(Ge, this.redactorDomChangedCallback);
  }
  /**
      ...
      function U(v, m) {
        ...
        if (m.singleton) {
          ...
          v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (x = function(B) {
            ...
            var ie = fe.css, He = fe.sourceMap, go = $.convertToAbsoluteUrls === void 0 && He;
            ($.convertToAbsoluteUrls || go) && (ie = g(ie)), He && (ie += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(He)))) + " */");
            var mo = new Blob([ie], { type: "text/css" }), ft = B.href;
            B.href = URL.createObjectURL(mo), ft && URL.revokeObjectURL(ft);
...
var Bi = Gt.exports;
const Ti = /* @__PURE__ */ Re(Bi);
function st(n, e) {
  return n.map((t) => {
    const o = L(e) ? e(t.tool) : e;
    return X(o) || (t.data = nt(t.data, o)), t;
  });
}
function q(n, e = {}) {
  const t = {
  ...
  return new Ti(t).clean(n);
}
function nt(n, e) {
  return Array.isArray(n) ? Ci(n, e) : R(n) ? Si(n, e) : Q(n) ? Ii(n, e) : n;
}
function Ci(n, e) {
  return n.map((t) => nt(t, e));
}
function Si(n, e) {
  const t = {};
  for (const o in n) {
...
const rt = class to extends Be {
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o) => ({
      icon: t.icon,
      title: W.t(V.toolNames, t.title || Le(o.name)),
      name: o.name,
      onActivate: () => {
...
eo([
  he
], rt.prototype, "toolsToBeDisplayed", 1);
eo([
  he
], rt.prototype, "toolboxItemsToBeDisplayed", 1);
let Wi = rt;
const Ki = "block hovered";
...
class Vi extends y {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.toolboxInstance.opened && this.toolboxInstance.close(), this.Editor.BlockSettings.opened && this.Editor.BlockSettings.close(), e && (this.hoveredBlock = e, this.assignToolbarPosition(e), this.Editor.BlockManager.blocks.length === 1 && e.isEmpty ? this.blockTunesToggler.hide() : this.blockTunesToggler.show(), this.open());
  }
  /**
   * Close the Toolbar
   */
  ...
  async make() {
    ...
    const t = d.make("div"), o = d.text(W.ui(V.ui.blockTunes.toggler, "Click to tune")), i = await Xi("Slash", "/");
    t.appendChild(o), t.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
      textContent: Qe(`CMD + ${i}`)
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new Wi({
   ...
   * @param block - block to move Toolbar near it
   */
  assignToolbarPosition(e = this.Editor.BlockManager.currentBlock) {
    if (!e)
      return;
    const t = e.holder, { isMobile: o } = this.Editor.UI, i = e.pluginsContent, s = window.getComputedStyle(i), r = parseInt(s.paddingTop, 10), l = parseInt(s.paddingLeft, 10), a = t.offsetHeight;
    let c;
    o ? c = t.offsetTop + a : c = t.offsetTop + r;
    const u = t.offsetLeft + l;
    this.nodes.wrapper.style.top = `${Math.floor(c)}px`, this.nodes.wrapper.style.left = `${Math.floor(u)}px`;
  }
  /**
   * Enable bindings
   */
  enableModuleBindings() {
    ...
    }, !0), ue() || (this.eventsDispatcher.on(Ki, (e) => {
      var t;
...
var Fe = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(Fe || {}), Se = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(Se || {}), oo = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(oo || {}), se = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n.IsEnabledMutationObserver = "isEnabledMutationObserver", n))(se || {}), lt = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n))(lt || {}), Je = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(Je || {});
class at {
  /**
   * @class
...
class qi extends y {
  ...
  close() {
    ...
    this.opened && (this.Editor.ReadOnly.isEnabled || (Array.from(this.toolsInstances.entries()).forEach(([o, i]) => {
      ...
      s && de.remove(this.Editor.UI.nodes.redactor, s), L(i.clear) && i.clear();
  ...
  async getInlineTools() {
    ...
    for (let s = 0; s < o.length; s++) {
      ...
      const u = c !== void 0 ? Qe(c) : void 0, h = W.t(
        V.toolNames,
        r.title || Le(r.name)
      );
      [a].flat().forEach((p) => {
  ...
  getToolShortcut(e) {
    ...
    return Array.from(i.keys()).includes(e) ? this.inlineTools[e][oo.Shortcut] : o == null ? void 0 : o.shortcut;
  }
  /**
...
function Me(n) {
  ...
  const [t, o] = io();
  return t === null ? !1 : so(n, t, o, "right");
}
class Zi extends y {
  /**
  ...
  enter(e) {
    ...
    if (i === void 0 || i.tool.isLineBreaksEnabled || o.someToolbarOpened && o.someFlipperButtonFocused || e.shiftKey && !Ze)
      return;
    let s = i;
  ...
  backspace(e) {
    ...
    if (i === void 0 || !b.isCollapsed || !i.currentInput || !Ie(i.currentInput))
      return;
    if (e.preventDefault(), this.Editor.Toolbar.close(), t.previousBlock && t.previousBlock.inputs.length, console.log("no delete"), !isFirstInputFocused) {
      o.navigatePrevious();
      return;
    }
    if (s === null)
...
const Bt = "block-removed", Tt = "block-added", Gi = "block-moved", Ct = "block-changed";
class Ji {
  constructor() {
...
class Qi extends y {
  ...
  async mergeBlocks(e, t) {
    ...
    if (e.name === t.name && e.mergeable) {
      ...
      const [s] = st([i], e.tool.sanitizeConfig);
      o = s;
    } else if (e.mergeable && Ae(t, "export") && Ae(e, "import")) {
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Gi, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
...
class De extends y {
  ...
  setToTheLastBlock() {
    ...
    e && e.tool.isDefault && e.isEmpty && this.setToBlock(e);
  }
  /**
  ...
  navigateNext(e = !1) {
    ...
    return s && c ? (this.setToInput(s, this.positions.START), !0) : a === null && (o.tool.isDefault || !c) ? !1 : c ? (this.setToBlock(a, this.positions.START), !0) : !1;
  }
  /**
...
class is extends y {
   ...
   */
  redactorChanged(e) {
    this.eventsDispatcher.emit(Ge, {
      mutations: e
    });
  }
}
const no = class ro extends y {
  constructor() {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const r = e.getData(this.MIME_TYPE), l = e.getData("text/plain").replace(/(\r\n|\n|\r)/gm, "");
    let a = e.getData("text/plain").replace(/(\r\n|\n|\r)/gm, "");
    if (r)
      try {
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (I(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (I(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => Bo(s) ? !0 : (I(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  async processFile(e) {
    const t = Eo(e), o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: l, extensions: a }]) => {
  ...
  async processInlinePaste(e) {
    ...
    if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < ro.PATTERN_PROCESSING_MAX_LENGTH) {
...
no.PATTERN_PROCESSING_MAX_LENGTH = 450;
let ss = no;
class ns extends y {
  constructor() {
...
class we extends y {
  ...
  enableModuleBindings() {
    ...
    }, !1), this.listeners.on(document.body, "mousemove", kt((t) => {
      this.processMouseMove(t);
    }, 10), {
      passive: !0
    }), this.listeners.on(document.body, "mouseleave", () => {
      this.processMouseLeave();
    }), this.listeners.on(window, "scroll", kt((t) => {
...
class ls extends y {
  ...
  async save() {
    ...
    try {
      ...
      const s = await Promise.all(i), r = await st(s, (l) => t.blockTools.get(l).sanitizeConfig);
...
const as = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
function cs(n) {
...
class ct {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : ct.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = t.preserveBlank ?? !1;
  }
  /**
...
class ds extends at {
   ...
   */
  get title() {
    return this.constructable[lt.Title];
  }
  /**
...
var us = Object.defineProperty, ps = Object.getOwnPropertyDescriptor, co = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ps(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
...
class pt extends at {
   ...
   */
  get isEnabledMutationObserver() {
    return this.constructable[se.IsEnabledMutationObserver] !== !1;
  }
  /**
   ...
   */
  get toolbox() {
    const e = this.constructable[se.Toolbox], t = this.config[Se.Toolbox];
    if (!X(e) && t !== !1)
...
co([
  he
], pt.prototype, "sanitizeConfig", 1);
co([
  he
], pt.prototype, "baseSanitizeConfig", 1);
class fs {
  /**
   * @class
   ...
   */
  get(e) {
    const { class: t, isInternal: o = !1, ...i } = this.config[e], s = this.getConstructor(t), r = t[Je.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
class ho {
   ...
   */
  handleClick() {
    const e = this.api.blocks.getCurrentBlockIndex(), t = this.api.blocks.getBlockByIndex(e + 1), o = this.api.blocks.getBlockByIndex(e);
    if (console.log("api: ", o), !t)
      throw new Error("Unable to move Block down since it is already the last");
    const i = t.holder, s = i.getBoundingClientRect();
    let r = Math.abs(window.innerHeight - i.offsetHeight);
    s.top < window.innerHeight && (r = window.scrollY + i.offsetHeight), window.scrollTo(0, r), this.api.blocks.move(e + 1), this.api.toolbar.toggleBlockSettings(!0);
  }
}
ho.isTune = !0;
class uo {
...
po.isTune = !0;
var gs = Object.defineProperty, ms = Object.getOwnPropertyDescriptor, bs = (n, e, t, o) => {
...
class fo extends y {
   ...
   */
  async prepare() {
    if (this.validateTools(), this.config.tools = Ve({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0)
      throw Error("Can't start without tools");
    const e = this.prepareConfig();
    this.factory = new fs(e, this.config, this.Editor.API);
...
class ws extends y {
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(t) && o) {
      ...
      const i = t.getAttribute("href"), s = Co(i);
      Io(s);
      return;
    }
  ...
  processBottomZoneClick(e) {
    ...
    e.target instanceof Element && e.target.isEqualNode(this.nodes.redactor) && /**
...
class ys {
  ...
  set configuration(e) {
    ...
    R(e) ? this.config = {
      ...
      holder: e
    }, qe(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = St.VERBOSE), wo(this.config.logLevel), qe(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
